                                      ...
                                      "k2"), op = c("~", "~", "~", "~", ":=", ":=", "~", "~", "~",
                                                    "~", ":=", ":=", "~", "~", "~", "~", ":=", ":="), rhs = c("X_A",
                                                                                                              ...
                                                                                                              "p2/a2"), label = c("a1", "a2", "p1", "p2", "k1", "k2", "a1",
                                                                                                                                  ...
                                                                                                                                  "k2"), est = c(-0.0346181970897649, 0.250325728848689, -0.0602157802670169,
                                                                                                                                                 -0.0306934264880344, 1.73942565844424, -0.122613950348617,
                                                                                                                                                 0.0726497142052772, 0.0820135266464923, -0.00700001507052668,
                                                                                                                                                 -0.0111344804747975, -0.0963529608767299, -0.135763951753851,
                                                                                                                                                 -0.0119434163282345, 0.26320489663308, 0.0649417922262329,
                                                                                                                                                 0.131558928924028, -5.43745528427313, 0.499834655840114),
                              se = c(0.10020955250621, 0.106733862676509, 0.0810716223487215,
                                     0.0761159653814894, NA, NA, 0.101369016096909, 0.10276768138794,
                                     0.0839398597692459, 0.0827974406078169, NA, NA, 0.137464961044782,
                                     0.101519494252679, 0.084963234822492, 0.115046551906992,
                                     NA, NA), z = c(-0.345458054885731, 2.34532624015848, -0.742747937225244,
                                                    -0.403245578430235, NA, NA, 0.716685600813407, 0.798047844797607,
                                                    -0.0833932185468264, -0.134478558673543, NA, NA, -0.086883350036696,
                                                    2.59265374173328, 0.764351691198098, 1.14352778717249, NA,
                                                    NA), pvalue = c(0.730124332229571, 0.0200206831247657, 0.458532723643062,
                                                                    0.6872116410864, NA, NA, 0.474430020354127, 0.425818515409186,
                                                                    0.933624866146542, 0.89316357768276, NA, NA, 0.930853844656676,
                                                                    0.0102491963092475, 0.445586378927608, 0.254228629378664,
                                                                    NA, NA), ci.lower = c(-0.231025310908812, 0.0411312020718868,
                                                                                          -0.219113240238744, -0.179877977284251, NA, NA, -0.126029906492926,
                                                                                          -0.119407427648556, -0.171519117085591, -0.173414482078213,
                                                                                          NA, NA, -0.281369789112208, 0.0642303441691072, -0.101583088035871,
                                                                                          -0.0939281693591948, NA, NA), ci.upper = c(0.161788916729282,
